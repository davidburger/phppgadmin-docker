<?php
    ...
    $autoloadDir = __DIR__ . DIRECTORY_SEPARATOR . 'autoload';
    $defaultServerConfig = __DIR__ . DIRECTORY_SEPARATOR . 'default_server.inc.php';
    $conf = [];
    ...
    if (
        ...
        $configs = glob( $autoloadDir . DIRECTORY_SEPARATOR . '*.inc.php');
    ...
    foreach($configs as $index => $filename) {
